...
public final class JobsDatabase {
    ...
    public Future<WriteResult> addJob(Job newJob) {
        ...
        // Creates a new Job object whose jobId is the autogenerated cloud firestore id
    ...
    public Future<WriteResult> setJob(String jobId, Job updatedJob) throws IllegalArgumentException {
        ...
        Job job = Job.newBuilder()
                .setJobId(jobId)
                .setJobTitle(updatedJob.getJobTitle())
                .setLocation(updatedJob.getJobLocation())
                .setJobDescription(updatedJob.getJobDescription())
                .setJobPay(updatedJob.getJobPay())
                .setRequirements(updatedJob.getRequirements())
                .setPostExpiry(updatedJob.getPostExpiryTimestamp())
                .setJobDuration(updatedJob.getJobDuration())
                .build();
